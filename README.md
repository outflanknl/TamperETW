...
MDSec's Adam Chester (@_xpn_) recently [published a great blog](https://www.mdsec.co.uk/2020/03/hiding-your-net-etw/) on how RedTeams can hide the execution of .NET assemblies by disabling .NET ETW telemetry. In his blog he included proof of concept code which demonstrates how to dismantle ETW telemetry by patching the native EtwEventWrite function.
...
Based on research from: Adam Chester ([@_xpn_](https://twitter.com/_xpn_)) / MDSec
